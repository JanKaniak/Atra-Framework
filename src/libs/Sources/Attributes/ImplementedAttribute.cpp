...
bool IntegerNumberBaseAttributeClass<TypeT,AttributeDescriptionT>::saveToJson(nlohmann::ordered_json &json, std::string &outputMessage)  {
...
bool AttributeBool::saveToJson(nlohmann::ordered_json &json, std::string &outputMessage) {
    json.push_back(nlohmann::ordered_json::object_t::value_type("Attribute name", getName()));
    json.push_back(nlohmann::ordered_json::object_t::value_type("Value",getValue()));
    return true;
}